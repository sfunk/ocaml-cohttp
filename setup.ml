...
(* OASIS_START *)
(* DO NOT EDIT (digest: 70f8830fb472d64cd5bfedeb5a14bf5f) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_events.ml"; });
               Test
                 ({
                     cs_name = "test_accept";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "ödðW\129\1389:Ö\014\159\155Ð×\003ü";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
